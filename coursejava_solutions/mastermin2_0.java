			...
			for(k=0;k<4;k++){
				...
				if(compareR[0]==characters[k] && k!=0){
					if(compareR[k]==characters[0]){
						if(compareR[0]==characters[l-1]){
							if(compareR[l-1]==characters[0]){
								if(compareR[0]!=characters[k]){
									r++;
				...
				if(compareR[1]==characters[k] && k!=1){
					if(compareR[k]==characters[1]){
						if(compareR[1]==characters[l-1]){
							if(compareR[l-1]==characters[1]){
								if(compareR[1]=characters[k]){
									r++;
									System.out.println("L: "+l);
								}
							}
				...
				if(compareR[2]==characters[k] && k!=2){
					if(compareR[k]==characters[2]){
						if(compareR[2]==characters[l-1]){
							if(compareR[l-1]==characters[2]){
								if(compareR[2]!=characters[k]){
									r++;
									System.out.println("L: "+l);
								}
							}
				...
				if(compareR[3]==characters[k] && k!=3){
					if(compareR[k]==characters[3]){
						if(compareR[3]==characters[l-1]){
							if(compareR[l-1]==characters[3]){
								if(compareR[3]!=characters[k]){
									r++;
									System.out.println("L: "+l);
								}
							}
